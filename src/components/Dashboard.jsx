          ...
          <form>
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                type="submit"
                className=" w-80 bg-customOrange hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
              >
                {" "}
                Update{" "}
              </button>
            ...
            <button
              onClick={(e) => signOut(e)}
              className="w-80 bg-red-700 mt-4 hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            >
              sign out
            </button>
          </form>
